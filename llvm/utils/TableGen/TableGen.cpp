...
namespace {
  ...
  Action(cl::desc("Action to perform:"),
         cl::values(clEnumValN(PrintRecords, "print-records",
                    ...
                    clEnumValN(GenOnnxSmokeTests, "gen-onnx-smoke-tests",
                               "Generate onnx smoke tests"),
                    clEnumValN(GenOnnxTests, "gen-onnx-tests",
                               "Generate onnx conformance tests")));
...
bool LLVMTableGenMain(raw_ostream &OS, RecordKeeper &Records) {
  ...
  case GenExegesis:
    ...
    break;
  case GenOnnxTests:
    EmitOnnxTests(Records, OS);
    break;
  case GenOnnxSmokeTests:
    EmitOnnxTests(Records, OS, true);
    break;
  }
